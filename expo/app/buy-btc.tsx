...
export default function BuyBTCScreen() {
  ...
  const calculateBTC = (euros: string): string => {
    if (!euros || parseFloat(euros) <= 0) return '0.00000000';
    const btcPrice = 85000;
    const btcAmount = parseFloat(euros) / btcPrice;
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={[styles.header, { paddingTop: 20 }]}>
        ...
        <Text style={styles.headerTitle}>Acheter du BTC</Text>
        ...
        <View style={styles.section}>
          ...
          {amount && parseFloat(amount) > 0 && (
            <View style={styles.conversionContainer}>
              <Text style={styles.conversionLabel}>≈ {calculateBTC(amount)} BTC</Text>
              <Text style={styles.conversionNote}>Taux indicatif : 1 BTC = 85,000 €</Text>
            </View>
          )}
        </View>
        ...
        {selectedMethod && (
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Les transactions d&apos;achat de BTC sont sécurisées et traitées par des fournisseurs
              de paiement certifiés. Votre BTC sera crédité sur votre portefeuille dans un délai
