  ...
  const renderPermissionBadge = (level: DeveloperPermissionLevel) => {
    ...
    return (
      <View style={[styles.permissionBadge, styles.permissionBadgePartial]}>
        <Text style={styles.permissionBadgeTextPartial}>Pseudo uniquement</Text>
      </View>
    );
  };
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 40 }]}>
        ...
        <View style={styles.legendCard}>
          ...
          <View style={styles.legendItem}>
            <Text style={styles.legendBullet}>•</Text>
            <Text style={styles.legendText}>
              100% Dev : Toutes les permissions (pseudos, images, comptes)
            </Text>
          </View>
          <View style={styles.legendItem}>
            <Text style={styles.legendBullet}>•</Text>
            <Text style={styles.legendText}>
              Pseudo uniquement : Peut seulement modifier les pseudos
            </Text>
          </View>
        </View>
      </ScrollView>
      ...
      >
        ...
        >
          <Pressable style={styles.modalContent} onPress={(e) => e.stopPropagation()}>
            ...
            <Text style={styles.inputLabel}>Adresse Bitcoin</Text>
            <TextInput
              style={styles.input}
              value={newAddress}
